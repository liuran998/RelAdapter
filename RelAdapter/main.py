...
if __name__ == '__main__':
    ...
    #Shuffle test data for random sampling with seed
    test_data = json.load(open(data_dir['test_tasks']))
    #Randomize test data by seed
    for rel in test_data:
        random.shuffle(test_data[rel])
    dataset['test_tasks'] = test_data
